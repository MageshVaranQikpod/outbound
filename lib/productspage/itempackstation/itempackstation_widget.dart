...
import 'itempackstation_model.dart';
export 'itempackstation_model.dart';

class ItempackstationWidget extends StatefulWidget {
  const ItempackstationWidget({
    super.key,
  ...
  @override
  State<ItempackstationWidget> createState() => _ItempackstationWidgetState();
}

class _ItempackstationWidgetState extends State<ItempackstationWidget> {
  late ItempackstationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ItempackstationModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.orderpatch = await OrderpatchCall.call(
        orderId: widget.orderid,
        status: 'packing_station',
      );

      if ((_model.orderpatch?.succeeded ?? true)) {
                                  ...
                                  Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: SizedBox(
                                        width: 300.0,
                                        height: 300.0,
                                        child: custom_widgets.Packingstationqr(
                                          width: 300.0,
                                          height: 300.0,
                                          orderid: widget.orderid,
                                          packingstation: NanoApiGroup
                                              .packingDispatchQcApiCall
                                              .packingstation(
                                            columnPackingDispatchQcApiResponse
                                                .jsonBody,
