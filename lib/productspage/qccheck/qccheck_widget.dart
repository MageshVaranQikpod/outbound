...
import 'qccheck_model.dart';
export 'qccheck_model.dart';

class QccheckWidget extends StatefulWidget {
  const QccheckWidget({
    super.key,
  ...
  @override
  State<QccheckWidget> createState() => _QccheckWidgetState();
}

class _QccheckWidgetState extends State<QccheckWidget> {
  late QccheckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QccheckModel());
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: NanoApiGroup.packingDispatchQcApiCall.call(
                                  ...
                                  Container(
                                    ...
                                    child: const Padding(
                                      ...
                                      child: SizedBox(
                                        width: 300.0,
                                        height: 300.0,
                                        child: custom_widgets.Qrmainscan(
                                          width: 300.0,
                                          height: 300.0,
                                        ),
                                      ),
                                    ...
                                    child: Container(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          _model.packingstationresult =
                                              await OrderpatchCall.call(
                                            orderId: widget.orderid,
                                            status: 'dispatch_station',
                                          );

                                          if ((_model.packingstationresult
                                                  ?.succeeded ??
                                              true)) {
                                            context.pushNamed(
                                              'dispatch',
