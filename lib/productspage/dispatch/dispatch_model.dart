...
import 'dart:async';
import 'dispatch_widget.dart' show DispatchWidget;
import 'package:flutter/material.dart';

class DispatchModel extends FlutterFlowModel<DispatchWidget> {
  ...
  // Stores action output result for [Backend Call - API (order bag and status patch)] action in dispatch widget.
  ApiCallResponse? dispatch;
