...
import 'dart:async';
import 'packingstation_widget.dart' show PackingstationWidget;
import 'package:flutter/material.dart';

class PackingstationModel extends FlutterFlowModel<PackingstationWidget> {
  ...
  // Stores action output result for [Backend Call - API (orderpatch)] action in packingstation widget.
  ApiCallResponse? packingstated;
