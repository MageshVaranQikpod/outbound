...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFFF9CCAE);
  ...
  late Color error = const Color(0xFFDF3F3F);
  ...
  late Color cardG2 = const Color(0xFF8E7CC3);
  late Color outline = const Color(0xFFEEECF1);
