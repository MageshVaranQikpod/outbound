...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    qikpodNanostoreOutboundAuthUserSubject.add(
      QikpodNanostoreOutboundAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<QikpodNanostoreOutboundAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  QikpodNanostoreOutboundAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = QikpodNanostoreOutboundAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    qikpodNanostoreOutboundAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
QikpodNanostoreOutboundAuthUser? currentUser;
